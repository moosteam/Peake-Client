...
const RankingList = () => {
  ...
  return (
    <div className="p-6 h-full overflow-auto">
      <div className="flex flex-row justify-between duration-300 transition-all">
        <div className="flex flex-col w-full pr-4">
          <SectionHeader
            title="랭킹"
            subtitle="실시간 유튜버 구독자 순위에요"
          />
          <div className="flex flex-wrap flex-row gap-3 mb-8">
          ...
          {/* Updated Ranking List - Made wider */}
