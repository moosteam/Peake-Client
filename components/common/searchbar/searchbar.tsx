...
interface SearchBarProps {
  searchTime: string;
  setSearchTime: (value: string) => void;
}

export default function SearchBar({ searchTime, setSearchTime }: SearchBarProps) {
    ...
    <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg flex justify-between">
      <div className="w-[50%]">
        <div className="flex items-center mb-2">
          ...
          <span className="text-blue-900 font-bold text-lg mt-2">
            구매하실 유튜버 채널명을 입력하세요.
          </span>
        </div>
        ...
        <div className="mt-4 flex items-center">
          <div className="relative w-full">
            ...
            <div className="absolute right-3 top-1/2 transform -translate-y-1/2 flex items-center pointer-events-none">
              <span className="text-gray-400 text-xs px-1.5 py-0.5 rounded border border-gray-300 bg-gray-50">
                Ctrl+Alt+K
              </span>
            </div>
              ...
              <div className="flex justify-between items-center">
                <p className="text-[28px] font-bold text-gray-800 flex items-center gap-3">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M260 682.412L376.143 587.071L496.278 698.025L354.754 823.747L370.295 733.212L291.083 765.905L311.638 691.465L260 682.412Z"
                      fill="white"
                      stroke="white"
                      strokeWidth="10"
                    />
                    <path
                      d="M353.102 663.835L403.994 621.1C404.346 620.804 404.855 620.787 405.227 621.059L430.692 639.659C430.779 639.722 430.854 639.798 430.916 639.885L452.282 669.798C452.566 670.195 452.521 670.739 452.176 671.085L406.302 717.068C405.672 717.699 404.594 717.253 404.594 716.361V684.306C404.594 683.606 403.895 683.123 403.241 683.37L369.079 696.277C368.212 696.605 367.404 695.679 367.846 694.865L382.925 667.077C383.287 666.411 382.804 665.6 382.046 665.6H353.745C352.811 665.6 352.387 664.435 353.102 663.835Z"
                      fill="white"
                      stroke="#2B7FFF"
                      strokeWidth="10"
                    />
                ...
                <button className="bg-blue-500 text-white px-4 py-3 rounded-[8px] font-medium text-[14px] flex items-center cursor-pointer mt-[-4]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
